...
SOURCEFILES_QUOTED_IF_SPACED=source/CRC16.c source/SerialDevice_pic8.c source/main_pic8.c source/hci_stack.c source/WMLW_API.c source/i2c.c source/T67xx.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/source/CRC16.p1 ${OBJECTDIR}/source/SerialDevice_pic8.p1 ${OBJECTDIR}/source/main_pic8.p1 ${OBJECTDIR}/source/hci_stack.p1 ${OBJECTDIR}/source/WMLW_API.p1 ${OBJECTDIR}/source/i2c.p1 ${OBJECTDIR}/source/T67xx.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/source/CRC16.p1.d ${OBJECTDIR}/source/SerialDevice_pic8.p1.d ${OBJECTDIR}/source/main_pic8.p1.d ${OBJECTDIR}/source/hci_stack.p1.d ${OBJECTDIR}/source/WMLW_API.p1.d ${OBJECTDIR}/source/i2c.p1.d ${OBJECTDIR}/source/T67xx.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/source/CRC16.p1 ${OBJECTDIR}/source/SerialDevice_pic8.p1 ${OBJECTDIR}/source/main_pic8.p1 ${OBJECTDIR}/source/hci_stack.p1 ${OBJECTDIR}/source/WMLW_API.p1 ${OBJECTDIR}/source/i2c.p1 ${OBJECTDIR}/source/T67xx.p1

# Source Files
SOURCEFILES=source/CRC16.c source/SerialDevice_pic8.c source/main_pic8.c source/hci_stack.c source/WMLW_API.c source/i2c.c source/T67xx.c
...
${OBJECTDIR}/source/T67xx.p1: source/T67xx.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/source" 
	@${RM} ${OBJECTDIR}/source/T67xx.p1.d 
	@${RM} ${OBJECTDIR}/source/T67xx.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=+mcof,-elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/source/T67xx.p1  source/T67xx.c 
	@-${MV} ${OBJECTDIR}/source/T67xx.d ${OBJECTDIR}/source/T67xx.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/source/T67xx.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
